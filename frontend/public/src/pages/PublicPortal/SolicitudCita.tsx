  ...
  return (
    <LocalizationProvider dateAdapter={AdapterDayjs}>
      <Box sx={{ maxWidth: 960, mx: 'auto', px: 2, py: 4 }}>
        ...
        <Box sx={{
          border: '1px solid', borderColor: 'primary.light',
          borderRadius: 3, p: 4, bgcolor: 'background.paper',
        }}>
          <Grid container spacing={4}>
            <Grid size={{ xs: 12, md: 6 }}>
              <Typography variant="subtitle1" sx={{ fontWeight: 700, color: 'primary.main', mb: 2, pb: 1, borderBottom: '2px solid', borderColor: 'primary.light' }}>
                Datos personales
              </Typography>
          ...
          <Box sx={{ textAlign: 'center', mt: 3 }}>
            <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 1, mb: 0.5 }}>
              ...
              <Typography variant="body2" sx={{ cursor: 'pointer', color: 'primary.main', fontWeight: 500 }}
            ...
            <Box>
              <Button variant="contained" size="large"
                ...
                sx={{ px: 6, py: 1.5, fontWeight: 700, letterSpacing: 0.5 }}>
