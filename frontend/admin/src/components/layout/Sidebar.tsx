...
const menuItems: MenuItem[] = [
  ...
  { label: 'Pacientes', path: '/pacientes', icon: <PatientsIcon />, roles: ['Administrador', 'Médico', 'Recepcionista'] },
  ...
  { label: 'Citas', path: '/citas', icon: <CalendarMonthIcon />, roles: ['Administrador', 'Médico', 'Recepcionista'] },
  { label: 'Reservas Web', path: '/reservas', icon: <BookOnlineIcon />, roles: ['Administrador', 'Médico', 'Recepcionista'] },
  { label: 'Habitaciones', path: '/habitaciones', icon: <HotelIcon />, roles: ['Administrador'] },
  { label: 'Admisiones', path: '/admisiones', icon: <AssignmentIcon />, roles: ['Administrador', 'Médico', 'Recepcionista', 'Enfermero'] },
